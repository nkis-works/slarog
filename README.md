...
`/` は日本国内向けのスラログ公式サイト、`/en/` と `/ja/` はNKIS Worksの英語・日本語案内として配信します。`/products/playlist-toolkit/` 以下は7言語の公開製品・法務・サポートページとしてsitemapへ掲載します。ブラウザ言語による強制転送は行わず、製品URLの初期表示は英語とします。
